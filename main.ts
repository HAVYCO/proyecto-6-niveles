...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Bumper, function (sprite, otherSprite) {
    if (sprite.x > 0 && !(sprite.isHittingTile(CollisionDirection.Bottom)) || sprite.x < otherSprite.x) {
        ...
        info.changeLifeBy(-1)
        sprite.say("¡Ay!", invincibilityPeriod)
...
function giveIntroduction () {
    ...
    game.setDialogCursor(img`
        ...
        . . . . . . . . . . . . . . . . 
        `)
    showInstruction(" Muévete con los botones izquierdo y derecho.")
    showInstruction("Salta con el botón arriba o A.")
    showInstruction("Doble salto presionando saltar de nuevo.")
}
function initializeCoinAnimation () {
    coinAnimation = animation.createAnimation(ActionKind.Idle, 30)
...
function initializeFlierAnimations () {
    ...
    flierFlying.addAnimationFrame(img`
        ...
        . . 8 8 1 1 2 8 8 1 1 2 2 2 . . 
        . 2 8 8 1 1 2 8 8 1 1 2 2 2 2 . 
    ...
    flierFlying.addAnimationFrame(img`
        ...
        . . 2 1 1 2 2 2 1 1 2 2 2 2 . . 
        . . 1 1 1 1 2 1 1 1 1 2 2 2 . . 
        . . 1 1 8 8 2 1 1 8 8 2 2 2 . . 
        . 2 1 1 8 8 2 1 1 8 8 2 2 2 2 . 
        . 2 2 1 1 2 2 2 1 1 2 2 2 2 2 . 
        . 2 2 2 2 2 2 2 2 2 2 2 2 2 2 . 
        . 2 2 2 2 2 2 2 2 2 2 2 2 2 2 . 
        . 2 2 2 2 2 2 2 2 2 2 2 2 2 2 . 
    ...
    flierFlying.addAnimationFrame(img`
        ...
        . 2 1 8 8 1 2 1 8 8 1 2 2 2 . . 
        . 2 1 8 8 1 2 1 8 8 1 2 2 2 2 . 
        . 2 2 1 1 2 2 2 1 1 2 2 2 2 2 . 
        . 2 2 2 2 2 2 2 2 2 2 2 2 2 2 . 
        . 2 2 2 2 2 2 2 2 2 2 2 2 2 2 . 
        . 2 2 2 2 2 2 2 2 2 2 2 2 2 2 . 
...
function animateRun () {
    ...
    mainRunLeft.addAnimationFrame(img`
        ...
        . . f 5 5 5 5 5 5 5 5 b f f . . 
        . . . f 5 5 b f f 5 5 5 f f . . 
        . . . . f f f . f f f f f . . . 
        `)
    mainRunLeft.addAnimationFrame(img`
        . . . . . . . . . . . . . . . . 
    ...
    mainRunRight.addAnimationFrame(img`
        ...
        . . f f b 5 5 5 5 5 5 5 5 f . . 
        . . f f 5 5 5 f f b 5 5 f . . . 
        . . . f f f f . . f f f . . . . 
        `)
    mainRunRight.addAnimationFrame(img`
        . . . . . . . . . . . . . . . . 
...
function animateJumps () {
    ...
    for (let index = 0; index < 30; index++) {
        mainJumpLeft.addAnimationFrame(img`
            ...
            . d 5 b c c c c c c c c b 5 d . 
            . d 5 c c c c c c c c c c 5 d . 
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Flier, function (sprite, otherSprite) {
    info.changeLifeBy(-1)
    sprite.say("¡Ay!", invincibilityPeriod * 1.5)
    music.powerDown.play()
